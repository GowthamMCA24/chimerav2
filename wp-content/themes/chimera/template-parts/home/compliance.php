<?php
/**
 * Template part for displaying the Compliance / standards section
 *
 * @package Chimera
 */
...
<section class="w-full bg-white py-[50px] relative overflow-hidden">
    <div class="container mx-auto px-6 text-center flex flex-col items-center">
        ...
        <!-- Compliance Badge -->
        <?php if ( $badge_text ) : ?>
            <div class="inline-flex font-jost items-center justify-center px-3 py-2 border border-orangeBorder rounded-[8px] text-xs font-semibold tracking-wider uppercase text-orange mb-5  animate-fade-in">
        ...
        <?php if ( $certificates && is_array( $certificates ) ) : ?>
            <div class="flex flex-row items-center justify-center gap-4 w-full max-w-lg mx-auto">
                ...
                ?>
                    ...
                    <div class="flex flex-col items-center gap-4 group">
                        <div class="flex items-center justify-center shadow-[0_4px_20px_-2px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_30px_-5px_rgba(255,74,3,0.1)] hover:scale-[1.02] transition-all duration-300 ">
                            <?php 
                                if ( $certificate_image ) {
                                    ...
                                    if ( ! empty( $image_url ) ) {
                                        echo '<img src="' . esc_url( $image_url ) . '" alt="' . esc_attr( $image_alt ) . '" class="object-contain">';
                                    }
                                }
                            ?>
                        </div>
