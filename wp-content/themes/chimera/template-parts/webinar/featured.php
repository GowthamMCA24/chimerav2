...
<section class="w-full pb-10 md:pb-[60px] pt-10 relative z-10">
    <div class="container">
        ...
        <?php if ($featured_query->have_posts()):
            ...
            <?php
            $featured_image = get_the_post_thumbnail_url(get_the_ID(), 'chimera-featured');
            if (!$featured_image) {
                        ...
                        <div class="flex items-center gap-[10px]">
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none">
                                    <path d="M13.332 11.6667V13.5L14.6654 14.3333" stroke="#FF4A03" stroke-width="1.66667"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M13.332 1.66666V4.99999" stroke="#FF4A03" stroke-width="1.66667"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                                    ...
                                    <path d="M2.5 8.33334H6.66667" stroke="#FF4A03" stroke-width="1.66667"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M6.66797 1.66666V4.99999" stroke="#FF4A03" stroke-width="1.66667"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                                        d="M13.332 18.3333C16.0935 18.3333 18.332 16.0948 18.332 13.3333C18.332 10.5719 16.0935 8.33334 13.332 8.33334C10.5706 8.33334 8.33203 10.5719 8.33203 13.3333C8.33203 16.0948 10.5706 18.3333 13.332 18.3333Z"
                                        stroke="#FF4A03" stroke-width="1.66667" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </div>
