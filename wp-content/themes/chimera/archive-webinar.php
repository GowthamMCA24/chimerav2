<?php
/**
 * The template for displaying the webinars archive page
 *
 * @package Chimera
 */
...
if ( function_exists('get_field') ) {
    ...
    $settings_page = get_page_by_path('webinar') ?: get_page_by_path('webinars');
...
<!-- Main Content Wrapper for Webinar Archive Listing Page -->
<main id="archive-listing" class="site-main overflow-hidden">
    
    <?php get_template_part( 'template-parts/blog/hero', null, $archive_args ); ?>

    <!-- Featured Webinar -->
    <?php get_template_part( 'template-parts/webinar/featured', null, $archive_args ); ?>
